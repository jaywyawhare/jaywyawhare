...
<p align="center"> <a href="https://meme-api-production.up.railway.app/meme?timestamp=<%= new Date().getTime() %>" target="'_blank" rel="noreferrer"><img src="https://meme-api-production.up.railway.app/meme?timestamp=<%= new Date().getTime() %>" width="512px"/> </a> </p>
